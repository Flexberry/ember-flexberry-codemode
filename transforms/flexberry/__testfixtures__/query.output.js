...
let x = new ComplexPredicate(Condition.Or, new SimplePredicate('id', FilterOperator.Ge, 'id'), new SimplePredicate('id', FilterOperator.Geq, 'id'));
let y = new ComplexPredicate(Condition.And, new SimplePredicate('id', FilterOperator.Ge, 'id'), new SimplePredicate('id', FilterOperator.Geq, 'id'));
